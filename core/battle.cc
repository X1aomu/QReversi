...
{
  connect(&m_gamePlay, &GamePlay::sigCheckerBoardChanged, this,
          &Battle::gamePlayCheckerBoardChangedHandler);
...
void Battle::startNewBattle(Battle::PlayerType blackPlayerType, Battle::PlayerType whitePlayerType,
                            QString blackPlayerName, QString whitePlayerName)
{
  endBattle();
...
{
  auto playerToMove =
      m_gamePlay.getCurrentPlayerColor() == PlayerColor::Black ? m_playerBlack : m_playerWhile;
